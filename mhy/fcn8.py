...
class FCN8(object):
    ...
    def build(self, mode, config):
        ...
        P5 = KL.Conv2D(1, (1, 1), padding="same", activation="relu", name="fcn_p5conv")(P5)
        P5 = KL.Conv2DTranspose(1, (4, 4), strides=2, padding="same", activation="relu", name="fcn_p5up")(P5)

        P4 = KL.Conv2D(1, (1, 1), padding="same", activation="relu", name="fcn_p4conv")(C4)
        P4 = KL.Add(name="fcn_p4add")([P4, P5])
        P4 = KL.Conv2DTranspose(1, (4, 4), strides=2, padding="same", activation="relu", name="fcn_p4up")(P4)

        P3 = KL.Conv2D(1, (1, 1), padding="same", activation="relu", name="fcn_p3conv")(C3)
