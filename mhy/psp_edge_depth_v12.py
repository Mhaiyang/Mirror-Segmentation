...
class PSP_EDGE_DEPTH(object):
    ...
    def build(self, mode, config):
        ...
        depth_c1 = KL.Conv2D(256, (3, 3), strides=(2, 2), padding="same", name="depth_c1")(C1)
        depth_c2 = KL.Conv2D(256, (3, 3), strides=(1, 1), padding="same", name="depth_c2")(C2)
        depth_c3 = KL.Conv2DTranspose(256, (4, 4), strides=(2, 2), padding="same", name="depth_c3")(C3)
        ...
        depth_feature = KL.Conv2D(256, (3, 3), strides=(2, 2), padding="same", name="depth_feature")(depth_conv3)
