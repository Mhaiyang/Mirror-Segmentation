...
class PSP_EDGE_DEPTH(object):
    ...
    def build(self, mode, config):
        ...
        x = KL.Conv2D(512, (3, 3), strides=(1, 1), padding="same", name="semantic_feature", use_bias=False)(psp_semantic)
        x = BN(name="semantic_feature_bn")(x)
        x = KL.Activation('relu')(x)
        ...
        # final prediction.
        final = KL.Concatenate(axis=3, name="final_fusion")([x, edge_feature, depth_feature])
