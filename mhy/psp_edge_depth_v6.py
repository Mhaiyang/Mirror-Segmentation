...
class PSP_EDGE_DEPTH(object):
    ...
    def build(self, mode, config):
        ...
        # semantic branch. 1/8 of input image
        ...
        edge_c3 = KL.Conv2DTranspose(256, (3, 3), strides=(2, 2), padding="same", activation="relu", name="edge_c3")(C3)
        ...
        edge_conv3 = KL.Conv2D(256, (3, 3), strides=(1, 1), padding="same", name="edge_conv3")(edge_conv2)
        edge_conv3 = BN(name="edge_bn")(edge_conv3)
        edge_conv3 = KL.Activation("relu")(edge_conv3)

        edge_feature = KL.Conv2D(128, (3, 3), strides=(1, 1), padding="same",
        ...
        depth_conv3 = KL.Conv2D(256, (3, 3), strides=(1, 1), padding="same", name="depth_conv3")(depth_conv2)
        depth_conv3 = BN(name="depth_bn")(depth_conv3)
        depth_conv3 = KL.Activation("relu")(depth_conv3)

        depth_feature = KL.Conv2D(128, (3, 3), strides=(1, 1), padding="same",
        ...
        # 1/4
        x = KL.Conv2DTranspose(256, (3, 3), strides=2, padding="same", activation="relu", name="decoder_conv1_1")(x)
        x = KL.Add(name="addc2")([x, C2])
        x = KL.Concatenate(axis=3, name="fusion")([x, edge_feature, depth_feature])
        x = KL.Conv2D(256, (3, 3), strides=1, padding="same", name="decoder_conv1_2")(x)
        x = BN(name="decoder_bn1")(x)
        x = KL.Activation("relu")(x)
