...
class PSP_EDGE_DEPTH(object):
    ...
    def build(self, mode, config):
        ...
        # semantic branch
        fusion_1 = KL.AveragePooling2D((4, 4), strides=(4, 4))(C1)
        fusion_1 = KL.Conv2D(256, (3, 3), padding="same", name="fusion1_conv")(fusion_1)

        fusion_2 = KL.AveragePooling2D((2, 2), strides=(2, 2))(C2)
        fusion_2 = KL.Conv2D(256, (3, 3), padding="same", name="fusion2_conv")(fusion_2)

        fusion_3 = KL.Conv2D(256, (3, 3), padding="same", name="fusion3_conv")(C3)

        fusion_4 = KL.Conv2D(256, (3, 3), padding="same", name="fusion4_conv")(C4)

        res = KL.Conv2D(1024, (3, 3), padding="same", name="fusion5_conv")(res)

        fusion = KL.Concatenate(axis=3, name="semantic_fusion")([res, fusion_4, fusion_3, fusion_2, fusion_1])

        psp_semantic = build_pyramid_pooling_module(fusion, [640, 640], branch="_semantic")
