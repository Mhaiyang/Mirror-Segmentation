...
class PSP_EDGE_DEPTH(object):
    ...
    def build(self, mode, config):
        ...
        edge_conv3 = KL.Conv2D(256, (3, 3), strides=(1, 1), padding="same",
                               name="edge_conv3", use_bias=False)(edge_conv2)
        ...
        edge_feature = KL.Conv2D(256, (3, 3), strides=(2, 2), padding="same",
                                 name="edge_feature", use_bias=False)(edge_conv3)
        ...
        depth_fusion = KL.Conv2D(64, (3, 3), padding="same", name="depth_fusion_conv1", use_bias=False)(depth_fusion)
        depth_fusion = BN(name="depth_fusion_conv1_bn")(depth_fusion)
        depth_fusion = KL.Activation("relu")(depth_fusion)

        depth_feature = KL.Conv2D(256, (4, 4), strides=4, padding="same",
                                  name="depth_feature", use_bias=False)(depth_fusion)
        ...
        m = KL.Conv2D(1, (3, 3), strides=(1, 1), padding="same", name="final_conv2")(m)
        m = Interp([640, 640])(m)
