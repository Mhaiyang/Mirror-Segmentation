...
class UNET(object):
    ...
    def build(self, mode, config):
        ...
        up6 = KL.Conv2D(512, 2, activation='relu', padding='same', kernel_initializer='he_normal')(
            KL.UpSampling2D(size=(2, 2))(drop5))
        merge6 = KL.Concatenate(axis=3)([drop4, up6])
        # merge6 = KL.merge([drop4, up6], mode='concat', concat_axis=3)
        ...
        up7 = KL.Conv2D(256, 2, activation='relu', padding='same', kernel_initializer='he_normal')(
            KL.UpSampling2D(size=(2, 2))(conv6))
        merge7 = KL.Concatenate(axis=3)([conv3, up7])
        # merge7 = KL.merge([conv3, up7], mode='concat', concat_axis=3)
        ...
        up8 = KL.Conv2D(128, 2, activation='relu', padding='same', kernel_initializer='he_normal')(
            KL.UpSampling2D(size=(2, 2))(conv7))
        merge8 = KL.Concatenate(axis=3)([conv2, up8])
        # merge8 = KL.merge([conv2, up8], mode='concat', concat_axis=3)
        ...
        up9 = KL.Conv2D(64, 2, activation='relu', padding='same', kernel_initializer='he_normal')(
            KL.UpSampling2D(size=(2, 2))(conv8))
        merge9 = KL.Concatenate(axis=3)([conv1, up9])
        # merge9 = KL.merge([conv1, up9], mode='concat', concat_axis=3)
        ...
        if mode == "training":
            ...
            model = KM.Model(input_image, predict_mask, name='UNET')
