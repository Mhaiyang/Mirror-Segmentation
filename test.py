...
import mhy.psp_edge_depth_v9 as modellib

# Directories of the project
ROOT_DIR = os.getcwd()
MODEL_DIR = os.path.join(ROOT_DIR, "log", "psp_edge_depth_v9")
MIRROR_MODEL_PATH = os.path.join(MODEL_DIR, "mirror_psp_edge_depth_v9_all_40.h5")
IMAGE_DIR = os.path.join(ROOT_DIR, "data_640", "test2", "image")
MASK_DIR = os.path.join(ROOT_DIR, "data_640", "test2", "mask")
OUTPUT_PATH = os.path.join(ROOT_DIR, 'data_640', 'test2', "psp_edge_depth_v9")
