...
# Training dataset
dataset_train = depth.MirrorDataset()
...
# Validation dataset
dataset_val = depth.MirrorDataset()
...
# ## Create Model  ###
model = modellib.DEPTH(mode="training", config=config, model_dir=MODEL_DIR)
...
model.train(dataset_train, dataset_val,
            ...
            epochs=80,
            layers='all')
model_path = os.path.join(MODEL_DIR, "depth_all_80.h5")
