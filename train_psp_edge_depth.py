...
import os
import mirror
import mhy.psp_edge_depth_v10 as modellib
...
MODEL_DIR = os.path.join(ROOT_DIR, "log", "psp_edge_depth_v10")
...
model.train(dataset_train, dataset_val,
            ...
            epochs=40,
            layers='all')
model_path = os.path.join(MODEL_DIR, "mirror_psp_edge_depth_v10_all_40.h5")
